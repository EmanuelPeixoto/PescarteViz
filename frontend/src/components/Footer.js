        ...
        <div className="footer-main">
          <div className="footer-logo-section">
            ...
            <p className="footer-tagline">
              Projeto de Educação Ambiental do Licenciamento da Produção e Escoamento
              de Petróleo e Gás Natural no Polo Pré-Sal da Bacia de Santos e da Bacia de Campos
            </p>
          </div>
          ...
          <div className="footer-links">
            ...
            <div className="footer-links-column">
              ...
              <ul>
                ...
                <li><NavLink to="/analysis">Análise Avançada</NavLink></li>
              </ul>
            </div>
            ...
            <div className="footer-links-column">
              <h4>Contato</h4>
              <ul>
                <li><a href="mailto:contato@pescarte.org.br">contato@pescarte.org.br</a></li>
                <li><a href="tel:+55-21-2629-5562">+55 (21) 2629-5562</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="footer-partners">
          <div className="partners-grid">
            <div className="partner-item">
              <h5>Projeto de Educação Ambiental</h5>
